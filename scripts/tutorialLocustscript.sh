...
echo source ${p8computedir}/setup.sh >> ${scriptsdir}/locustcommands.sh
...
docker run -it --rm -v ~/p8tutorial:/tmp -v ~/p8tutorial/locust-tutorial/output:${p8locustdir}/output project8/p8compute /bin/bash -c /tmp/locust-tutorial/scripts/locustcommands.sh
